...
*/
@ApiMeta(
    path = "/wmoper/ng/foodop/food/sku/sellStatus",
    businessId = 16,
    apiVersion = "10003",
    apiName = "food_sku_sell_status",
    needAuth = true
)
public class FoodSkuSellStatusRequest implements MeituanRequest<String> {
    /**
    ...
    */
    ...
    public String toString() {
        return "FoodSkuSellStatusRequest{" + "sellStatus=" + sellStatus + "," + "foodData=" + foodData + "}";
    }
}
