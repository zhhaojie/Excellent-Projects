...
*/
@ApiMeta(
    path = "/wmoper/ng/foodop/food/sku/inc_stock",
    businessId = 16,
    apiVersion = "10004",
    apiName = "food_sku_inc_stock",
    needAuth = true
)
public class FoodSkuIncStockRequest implements MeituanRequest<String> {
    /**
    ...
    */
    ...
    public String toString() {
        return "FoodSkuIncStockRequest{" + "foodData=" + foodData + "}";
    }
}
