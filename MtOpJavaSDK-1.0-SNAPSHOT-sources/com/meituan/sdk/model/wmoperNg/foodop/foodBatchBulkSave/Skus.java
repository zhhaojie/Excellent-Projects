...
public class Skus {
    ...
    */
    ...
    public String toString() {
        return "Skus{" + "skuId=" + skuId + "," + "spec=" + spec + "," + "upc=" + upc + "," + "price=" + price + "," + "stock=" + stock + "," + "skuSequence=" + skuSequence + "," + "availableTimes=" + availableTimes + "," + "locationCode=" + locationCode + "," + "boxNum=" + boxNum + "," + "boxPrice=" + boxPrice + "," + "ladderNum=" + ladderNum + "," + "ladderPrice=" + ladderPrice + "," + "weight=" + weight + "," + "weightUnit=" + weightUnit + "}";
    }
}
