...
*/
@ApiMeta(
    path = "/wmoper/ng/foodop/food/batchbulksave",
    businessId = 16,
    apiVersion = "10036",
    apiName = "food_batch_bulk_save",
    needAuth = true
)
public class FoodBatchBulkSaveRequest implements MeituanRequest<String> {
    /**
    ...
    */
    ...
    public String toString() {
        return "FoodBatchBulkSaveRequest{" + "foodData=" + foodData + "}";
    }
}
