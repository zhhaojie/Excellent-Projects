...
*/
@ApiMeta(
    path = "/wmoper/ng/foodop/food/sku/stock",
    businessId = 16,
    apiVersion = "10004",
    apiName = "food_sku_stock",
    needAuth = true
)
public class FoodSkuStockRequest implements MeituanRequest<String> {
    /**
    ...
    */
    ...
    public String toString() {
        return "FoodSkuStockRequest{" + "foodData=" + foodData + "}";
    }
}
