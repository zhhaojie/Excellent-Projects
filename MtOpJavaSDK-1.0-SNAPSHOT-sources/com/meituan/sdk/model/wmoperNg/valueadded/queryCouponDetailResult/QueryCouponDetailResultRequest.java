...
*/
@ApiMeta(
    path = "/wmoper/ng/valueadded/queryCouponDetailResult",
    businessId = 16,
    apiVersion = "10016",
...
public class QueryCouponDetailResultRequest implements MeituanRequest<QueryCouponDetailResultResponse> {
    /**
    * <p><span style="color: "><font style="font-size:14px;line-height:22px" data-size="14">发券返回的id。</font></span></p><p><span style="color: "><font style="font-size:14px;line-height:22px" data-size="14">支持手机号发券生成的任务id。</font></span></p>
    */
