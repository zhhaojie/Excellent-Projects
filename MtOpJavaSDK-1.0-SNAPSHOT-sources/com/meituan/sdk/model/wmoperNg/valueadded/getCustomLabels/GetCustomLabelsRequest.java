...
*/
@ApiMeta(
    path = "/wmoper/ng/valueadded/getCustomLabels",
    businessId = 16,
    apiVersion = "10020",
...
public class GetCustomLabelsRequest implements MeituanRequest<List<LableResponse>> {
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">版本号。</font></span><span style="color: rgba(0, 0, 0, 0.87)"><font style="font-size:14px;line-height:22px" data-size="14">1.0老数据，2.0新数据</font></span></p>
    */
