...
*/
@ApiMeta(
    path = "/wmoper/ng/valueadded/async/taskResultQuery",
    businessId = 16,
    apiVersion = "10013",
...
public class TaskResultQueryRequest implements MeituanRequest<List<TaskResultQueryResponse>> {
    ...
    */
    ...
    /**
    * <p><span style="color: "><font style="font-size:14px;line-height:22px" data-size="14">任务请求id。</font></span></p><p><span style="color: "><font style="font-size:14px;line-height:22px" data-size="14">支持手机号发券生成的任务id</font></span></p>
    */
