...
public class CreateGroupRequest implements MeituanRequest<CreateGroupResponse> {
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">群聊类型，评价联系：1</font></span></p>
    */
    @NotNull(message = "groupType不能为空")
    @SerializedName("group_type")
    private Integer groupType;
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">评价联系需要的参数，group_type为1时的必填参数</font></span></p>
    */
