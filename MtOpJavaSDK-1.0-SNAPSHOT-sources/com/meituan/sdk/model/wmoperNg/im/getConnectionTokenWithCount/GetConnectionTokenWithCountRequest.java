...
*/
@ApiMeta(
    path = "/wmoper/ng/im/getConnectionTokenWithCount",
    businessId = 16,
    apiVersion = "10043",
...
public class GetConnectionTokenWithCountRequest implements MeituanRequest<GetConnectionTokenWithCountResponse> {
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">token数量，推荐3，最多为5</font></span></p>
    */
