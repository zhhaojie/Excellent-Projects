...
public class BlockUserRequest implements MeituanRequest<Void> {
    ...
    */
    ...
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">屏蔽类型，1：骚扰、辱骂我，言辞恶劣，2：让我加微信又不下单，疑似诈骗，3：其他</font></span></p>
    */
    @NotNull(message = "blockCode不能为空")
    @SerializedName("block_code")
    private Long blockCode;
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">屏蔽原因，当屏蔽类型为「其他」时该值必填</font></span></p>
    */
    @SerializedName("block_reason_desc")
    private String blockReasonDesc;
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">照片id，以，分割，最少1张，最多9张，通过图片上传接口获取图片id</font></span></p>
    */
