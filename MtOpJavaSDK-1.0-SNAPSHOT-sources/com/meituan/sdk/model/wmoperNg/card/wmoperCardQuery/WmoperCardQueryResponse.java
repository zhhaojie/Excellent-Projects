...
public class WmoperCardQueryResponse {
    ...
    */
    ...
    public String toString() {
        return "WmoperCardQueryResponse{" + "cardId=" + cardId + "," + "epoiId=" + epoiId + "," + "wmPoiName=" + wmPoiName + "," + "protocolStatus=" + protocolStatus + "," + "landPageUrl=" + landPageUrl + "," + "auditTip=" + auditTip + "," + "auditStatus=" + auditStatus + "," + "cardTime=" + cardTime + "," + "tips=" + tips + "," + "syncOpenReceipt=" + syncOpenReceipt + "," + "syncPost=" + syncPost + "," + "syncIM=" + syncIM + "," + "type=" + type + "," + "upgradeDetailList=" + upgradeDetailList + "," + "cardDetailList=" + cardDetailList + "," + "ctime=" + ctime + "," + "testingItemList=" + testingItemList + "}";
    }
}
