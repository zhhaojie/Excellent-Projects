...
public class WmProductSpu {
    ...
    */
    ...
    /**
    * <p data-diff-id="ct-diff-id-f95c30f8-d0aa-442b-adf7-544058d6a620">图文详情URL</p><p data-diff-id="ct-diff-id-941d1579-e03a-43a5-a015-11df162e2c18">英文逗号分隔不同图片链接</p><p data-diff-id="ct-diff-id-11f8e70d-ff51-480b-8ae4-252f84ffedec">不同图片没有no排序，C端按照逗号分隔后的顺序展示</p>
    */
