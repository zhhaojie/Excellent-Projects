...
public class ComboSpu {
    ...
    */
    ...
    /**
    * <p style="text-align: start;" data-diff-id="ct-diff-id-915fdd98-4b33-40fc-b9dd-3432f365b4ef">商品售卖时间</p><p data-diff-id="ct-diff-id-9576e802-818d-4e96-8b31-bebff001295b">如果所有时间都可售卖传-</p><p data-diff-id="ct-diff-id-25c7fa8e-9cd6-41cc-b233-092f908f0c30">如果需要分时售卖，支持周一到周日配置。</p>
    */
    ...
    */
    ...
    /**
    * <p data-diff-id="ct-diff-id-ecd05160-f4fa-4aff-a2b8-d879c3af0966">图文详情URL</p><p data-diff-id="ct-diff-id-4b1b4a55-2a1b-4e4d-b31d-a288000692d5">英文逗号分隔不同图片链接</p><p data-diff-id="ct-diff-id-bc802c4a-9781-455e-a03c-bb444b4175e6">不同图片没有no排序，C端按照逗号分隔后的顺序展示</p>
    */
