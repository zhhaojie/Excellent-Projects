package com.meituan.sdk.model.waimaiNg.dish.foodUpdateAppfoodcodeByNameAndSpec;
...
*/
@ApiMeta(
    path = "/waimai/ng/dish/food/updateAppFoodCodeByNameAndSpec",
    businessId = 2,
    apiVersion = "10069",
...
public class FoodUpdateAppfoodcodeByNameAndSpecRequest implements MeituanRequest<String> {
    ...
    */
    ...
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.87)"><font style="font-size:14px;line-height:22px" data-size="14">新appFoodCode，</font></span><font style="font-size:14px;line-height:22px" data-size="14"><br></font><span style="color: rgba(0, 0, 0, 0.87)"><font style="font-size:14px;line-height:22px" data-size="14">为商品的服务商方的商品id，不同门店可以重复，同一门店内不能重复，最大长度128</font></span></p>
    */
    @NotBlank(message = "appFoodCode不能为空")
    @SerializedName("appFoodCode")
    private String appFoodCode;
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.87)"><font style="font-size:14px;line-height:22px" data-size="14">新skuId，为商品sku的唯一标示,如商品有规格，则必填</font></span></p>
    */
    ...
    */
    ...
    public String toString() {
        return "FoodUpdateAppfoodcodeByNameAndSpecRequest{" + "name=" + name + "," + "categoryName=" + categoryName + "," + "appFoodCode=" + appFoodCode + "," + "skuId=" + skuId + "," + "spec=" + spec + "}";
    }
}
