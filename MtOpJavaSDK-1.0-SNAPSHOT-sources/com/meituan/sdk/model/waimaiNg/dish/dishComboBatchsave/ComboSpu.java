...
public class ComboSpu {
    ...
    */
    ...
    /**
    * <p data-diff-id="ct-diff-id-e3c17be9-2357-457c-af8d-0447e076aee9">商品售卖时间</p><p data-diff-id="ct-diff-id-d6b21dad-6097-4014-b284-3753cb629cb7">如果所有时间都可售卖传-</p><p data-diff-id="ct-diff-id-008b3d8c-433a-4721-892e-7f53de119ab5">如果需要分时售卖，支持周一到周日配置。</p>
    */
    ...
    */
    ...
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">标签列表。用“,”分隔。招牌=1，单点不送=32</font></span></p>
    */
    ...
    */
    ...
    /**
    * <p data-diff-id="ct-diff-id-f5e9a766-3d99-4712-a339-d641aeeb3178">图文详情URL</p><p data-diff-id="ct-diff-id-24038899-c58a-48b8-9381-8e0b0305326b">英文逗号分隔不同图片链接</p><p data-diff-id="ct-diff-id-029707fa-4558-4eed-9b88-440cf5e5f77f">不同图片没有no排序，C端按照逗号分隔后的顺序展示</p>
    */
