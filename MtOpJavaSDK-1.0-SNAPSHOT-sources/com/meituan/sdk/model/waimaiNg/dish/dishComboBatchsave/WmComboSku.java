...
/**
* <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">套餐sku信息。套餐商品的skuList的size必须为1，即只有一个元素</font></span></p>
* This file was automatically generated.
*/
public class WmComboSku {
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">第三方规格code。长度限制128</font></span></p>
    */
    ...
    */
    ...
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">售卖状态。0-恢复售卖，1-暂停售卖，默认0。需要与spuattr里的sell_status一致</font></span></p>
    */
    ...
    */
    ...
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">打包费。打包费最小为0，单位为元，保留两位小数。</font></span></p>
    */
    @NotNull(message = "ladderPrice不能为空")
    @SerializedName("ladder_price")
    private Double ladderPrice;
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">sku销售属性。即套餐sku对应的skuAttr。</font></span></p>
    */
    @NotEmpty(message = "skuAttrList不能为空")
    @SerializedName("skuAttrList")
    private List<WmComboSkuSalesAttr> skuAttrList;
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">分组可选套餐的分组信息。当套餐为可选分组套餐时，需要传入。当套餐为固定搭配套餐时，不传入。固定搭配套餐分组数量不能超过5个。</font></span></p>
    */
    @SerializedName("comboGroupList")
    private List<WmComboGroup> comboGroupList;
    /**
    * <p><font style="font-size:14px;line-height:22px" data-size="14">固定搭配套餐的单品关联信息。</font><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">固定搭配套餐必须传入，可选分组套餐不传入</font></span></p>
    */
