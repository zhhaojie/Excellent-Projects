...
public class WmComboSpuSalesAttr {
    ...
    */
    ...
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">属性价格。单位元，支持小数点后两位。套餐价格上限暂定为5000元</font></span></p>
    */
    @NotNull(message = "price不能为空")
    @SerializedName("price")
    private Double price;
    /**
    * <p><span style="color: rgba(0, 0, 0, 0.65)"><font style="font-size:14px;line-height:22px" data-size="14">属性值上下架状态。0-上架，1-下架，默认0</font></span></p>
    */
