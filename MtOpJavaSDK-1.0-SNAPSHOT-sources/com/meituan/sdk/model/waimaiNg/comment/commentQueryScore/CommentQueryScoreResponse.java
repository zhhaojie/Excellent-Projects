...
*/
public class CommentQueryScoreResponse {
    ...
    */
    ...
    public String toString() {
        return "CommentQueryScoreResponse{" + "epoiId=" + epoiId + "," + "avgPoiScore=" + avgPoiScore + "," + "avgTasteScore=" + avgTasteScore + "," + "avgPackingScore=" + avgPackingScore + "," + "avgDeliveryScore=" + avgDeliveryScore + "," + "deliverySatisfaction=" + deliverySatisfaction + "}";
    }
}
