...
*/
@ApiMeta(
    path = "/waimai/ng/im/queryEnterCouponActivity",
    businessId = 2,
    apiVersion = "10040",
...
public class QueryEnterCouponActivityRequest implements MeituanRequest<QueryEnterCouponActivityResponse> {
    /**
    * <p><span style="color: "><font style="font-size:14px;line-height:22px" data-size="14">查询游标，首次传0</font></span></p>
    */
    @SerializedName("index")
    private Long index;
    /**
    * <p><span style="color: "><font style="font-size:14px;line-height:22px" data-size="14">查询个数，大于1</font></span></p>
    */
    @SerializedName("size")
