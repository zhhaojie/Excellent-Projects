package com.meituan.sdk.model.waimaiNg.im.createEnterCouponActivity;
...
*/
@ApiMeta(
    path = "/waimai/ng/im/createEnterCouponActivity",
    businessId = 2,
    apiVersion = "10040",
...
public class CreateEnterCouponActivityRequest implements MeituanRequest<Void> {
    ...
    */
    ...
    /**
    * <p><span style="color: "><font style="font-size:14px;line-height:22px" data-size="14">优惠券金额 单位元</font></span></p>
    */
    @SerializedName("price")
    private Integer price;
    /**
    * <p><span style="color: "><font style="font-size:14px;line-height:22px" data-size="14">优惠券门槛 单位元</font></span></p>
    */
    @SerializedName("limitPrice")
    private Integer limitPrice;
    /**
    * <p><span style="color: "><font style="font-size:14px;line-height:22px" data-size="14">券有效期 </font></span></p>
    */
