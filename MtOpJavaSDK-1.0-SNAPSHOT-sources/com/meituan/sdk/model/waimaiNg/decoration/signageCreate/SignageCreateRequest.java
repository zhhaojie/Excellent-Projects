package com.meituan.sdk.model.waimaiNg.decoration.signageCreate;
...
*/
@ApiMeta(
    path = "/waimai/ng/decoration/signageCreate",
    businessId = 2,
    apiVersion = "10001",
    apiName = "signage_create",
    needAuth = false
)
public class SignageCreateRequest implements MeituanRequest<Boolean> {
    /**
    ...
    */
    ...
    public String toString() {
        return "SignageCreateRequest{" + "poiIds=" + poiIds + "," + "picCode=" + picCode + "}";
    }
}
