...
*/
@ApiMeta(
    path = "/waimai/ng/card/save",
    businessId = 2,
    apiVersion = "10011",
    apiName = "save_card",
    needAuth = false
)
public class SaveCardRequest implements MeituanRequest<SaveCardResponse> {
    /**
    ...
    */
    ...
    @Override
    public MeituanResponse<SaveCardResponse> deserializeResponse(String response) {
        Type type = new TypeToken<MeituanResponse<SaveCardResponse>>(){}.getType();
    ...
    public String toString() {
        return "SaveCardRequest{" + "cardDetailList=" + cardDetailList + "," + "tips=" + tips + "," + "syncPost=" + syncPost + "," + "type=" + type + "," + "syncIM=" + syncIM + "," + "upgradeDetailList=" + upgradeDetailList + "," + "syncOpenReceipt=" + syncOpenReceipt + "," + "testingItemList=" + testingItemList + "}";
    }
}
