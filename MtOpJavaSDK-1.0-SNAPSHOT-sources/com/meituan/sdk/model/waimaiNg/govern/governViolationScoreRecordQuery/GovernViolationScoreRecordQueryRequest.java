...
*/
@ApiMeta(
    path = "/waimai/ng/govern/violation/score/record/query",
    businessId = 2,
    apiVersion = "10001",
...
public class GovernViolationScoreRecordQueryRequest implements MeituanRequest<GovernViolationScoreRecordQueryResponse> {
    ...
    /**
    * <p><font style="font-size:14px;line-height:22px" data-size="14">1-一般违规</font></p><p><font style="font-size:14px;line-height:22px" data-size="14">51-严重违规</font></p><p><font style="font-size:14px;line-height:22px" data-size="14">0-同时包含一般和严重违规</font></p>
    */
