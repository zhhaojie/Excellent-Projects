...
public class ShippingInfo {
    ...
    */
    ...
    public String toString() {
        return "ShippingInfo{" + "appShippingCode=" + appShippingCode + "," + "area=" + area + "," + "logisticsCode=" + logisticsCode + "," + "logisticsType=" + logisticsType + "," + "minPrice=" + minPrice + "," + "shippingFee=" + shippingFee + "," + "timeRange=" + timeRange + "," + "type=" + type + "}";
    }
}
