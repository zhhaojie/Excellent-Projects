...
*/
@ApiMeta(
    path = "/dcps/fulfill/order/detail",
    businessId = 46,
    apiVersion = "10026",
    apiName = "groupbuy_order_detail",
    needAuth = true
)
public class GroupbuyOrderDetailRequest implements MeituanRequest<GroupbuyOrderDetailResponse> {
    ...
    @Override
    public MeituanResponse<GroupbuyOrderDetailResponse> deserializeResponse(String response) {
        Type type = new TypeToken<MeituanResponse<GroupbuyOrderDetailResponse>>(){}.getType();
    ...
    public String toString() {
        return "GroupbuyOrderDetailRequest{" + "bookingOrderId=" + bookingOrderId + "," + "opIp=" + opIp + "," + "opPlatform=" + opPlatform + "," + "opUuid=" + opUuid + "}";
    }
}
