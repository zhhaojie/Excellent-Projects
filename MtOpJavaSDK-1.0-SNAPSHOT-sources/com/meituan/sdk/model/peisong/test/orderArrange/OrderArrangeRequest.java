package com.meituan.sdk.model.peisong.test.orderArrange;
...
*/
@ApiMeta(
    path = "/peisong/test/orderArrange",
    businessId = 19,
    apiVersion = "10003",
    apiName = "order_arrange",
    needAuth = false
)
public class OrderArrangeRequest implements MeituanRequest<Void> {
    /**
    ...
    */
    ...
    public String toString() {
        return "OrderArrangeRequest{" + "deliveryId=" + deliveryId + "," + "mtPeisongId=" + mtPeisongId + "}";
    }
}
