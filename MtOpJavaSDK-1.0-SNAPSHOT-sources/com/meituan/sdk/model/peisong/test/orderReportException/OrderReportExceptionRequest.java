package com.meituan.sdk.model.peisong.test.orderReportException;
...
*/
@ApiMeta(
    path = "/peisong/test/orderReportException",
    businessId = 19,
    apiVersion = "10003",
    apiName = "order_report_exception",
    needAuth = false
)
public class OrderReportExceptionRequest implements MeituanRequest<Void> {
    /**
    ...
    */
    ...
    public String toString() {
        return "OrderReportExceptionRequest{" + "deliveryId=" + deliveryId + "," + "mtPeisongId=" + mtPeisongId + "}";
    }
}
