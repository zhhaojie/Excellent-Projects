package com.meituan.sdk.model.peisong.test.orderPickup;
...
*/
@ApiMeta(
    path = "/peisong/test/orderPickup",
    businessId = 19,
    apiVersion = "10003",
    apiName = "order_pickup",
    needAuth = false
)
public class OrderPickupRequest implements MeituanRequest<Void> {
    /**
    ...
    */
    ...
    public String toString() {
        return "OrderPickupRequest{" + "deliveryId=" + deliveryId + "," + "mtPeisongId=" + mtPeisongId + "}";
    }
}
