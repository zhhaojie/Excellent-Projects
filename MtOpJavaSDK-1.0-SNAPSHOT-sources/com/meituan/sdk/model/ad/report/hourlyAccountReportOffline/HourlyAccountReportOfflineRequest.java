...
*/
@ApiMeta(
    path = "/ad/report/getHourlyDataByAccountOffline",
    businessId = 22,
    apiVersion = "10014",
    apiName = "hourly_account_report_offline",
    needAuth = false
)
public class HourlyAccountReportOfflineRequest implements MeituanRequest<List<Data>> {
    ...
    */
    ...
    public String toString() {
        return "HourlyAccountReportOfflineRequest{" + "beginTime=" + beginTime + "," + "endTime=" + endTime + "}";
    }
}
